...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { email: @pessoa.email, idade: @pessoa.idade, msg: @pessoa.msg, nome: @pessoa.nome }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { email: @pessoa.email, idade: @pessoa.idade, msg: @pessoa.msg, nome: @pessoa.nome }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
